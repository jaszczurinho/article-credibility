...
QUERIES = ["climate change", "artificial intelligence", "war", "cybersecurity", "health"]
...
def main():
    ...
    reliable_results = fetch_newsapi_dataset(
        ...
        label=1,
        source_category="news_api_hybrid_reliable",
    ...
    unreliable_results = fetch_newsapi_dataset(
        ...
        label=0,
        source_category="news_api_hybrid_unreliable",
        articles_per_query=ARTICLES_PER_QUERY
    )
